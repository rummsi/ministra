...
function connectBluetoothDevice () {
	...
	new CModalConfirm(
		SettingsPage,
		_('Connection'),
		_('Device ') + ' ' + (device.name || device.address) + ' ' + _('will be paired'),
		_('Cancel'),
		null,
		_('Connect'),
		function () {
...
function serversPortalsMoreLoad ( noMessage ) {
	...
	var arr = [
		...
		{element: 'select', title: _('Portal load delay:'), option: portLoadDelayArray, selected: portals.time || 60},
