...
if (@$_GET['del'] && !empty($_GET['id'])) {
    ...
    \Ministra\Lib\S642b6461e59cef199375bfb377c17a39\L18e6d54d6202a6e70c8e428830aa4c89::getInstance()->delete('audio_performers', ['id' => (int) $_GET['id']]);
...
if (!empty($_POST)) {
    if (empty($_POST['name'])) {
        ...
        $performer_id = \Ministra\Lib\S642b6461e59cef199375bfb377c17a39\L18e6d54d6202a6e70c8e428830aa4c89::getInstance()->insert('audio_performers', ['name' => $_POST['name'], 'modified' => 'NOW()'])->insert_id();
        \header('Location: audio_performer.php');
        exit;
    } elseif (isset($_POST['update'])) {
        \Ministra\Lib\Admin::checkAccess(\Ministra\Lib\AdminAccess::ACCESS_EDIT);
        $performer_id = (int) $_GET['id'];
        \Ministra\Lib\S642b6461e59cef199375bfb377c17a39\L18e6d54d6202a6e70c8e428830aa4c89::getInstance()->update('audio_performers', ['name' => $_POST['name'], 'modified' => 'NOW()'], ['id' => $performer_id]);
        \header('Location: audio_performer.php');
        exit;
    }
}
...
$items = \Ministra\Lib\S642b6461e59cef199375bfb377c17a39\L18e6d54d6202a6e70c8e428830aa4c89::getInstance()->from('audio_performers');
...
$items = $items->get();
if (isset($_GET['id'])) {
    $current_performer = \Ministra\Lib\S642b6461e59cef199375bfb377c17a39\L18e6d54d6202a6e70c8e428830aa4c89::getInstance()->from('audio_performers')->where(['id' => (int) $_GET['id']])->get()->first();
}
?>
<body>
...
?>:
                                        ...
                                        <td>
                                            <input name="name" type="text"
                                                   value="<?php 
echo !empty($current_performer) ? $current_performer['name'] : '';
?>">
...
?>"
                                                   onclick="document.location='audio_performer.php'">
                                        </td>
                                    </tr>
                                </table>
                            </form>
