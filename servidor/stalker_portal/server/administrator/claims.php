...
if (@$_GET['reset'] && @$_GET['media_type'] && @$_GET['media_id']) {
    ...
    \Ministra\Lib\S642b6461e59cef199375bfb377c17a39\L18e6d54d6202a6e70c8e428830aa4c89::getInstance()->update('media_claims', ['sound_counter' => 0, 'video_counter' => 0, 'no_epg' => 0, 'wrong_epg' => 0], ['media_id' => (int) $_GET['media_id']]);
...
$MAX_PAGE_ITEMS = 30;
$where = '';
$total_items = \Ministra\Lib\S642b6461e59cef199375bfb377c17a39\L18e6d54d6202a6e70c8e428830aa4c89::getInstance()->query("select * from daily_media_claims {$where}")->count();
$page_offset = $page * $MAX_PAGE_ITEMS;
$total_pages = (int) ($total_items / $MAX_PAGE_ITEMS + 0.999999);
$query = "select * from daily_media_claims {$where} order by date desc LIMIT {$page_offset}, {$MAX_PAGE_ITEMS}";
$all_claims = \Ministra\Lib\S642b6461e59cef199375bfb377c17a39\L18e6d54d6202a6e70c8e428830aa4c89::getInstance()->query($query);
?>
