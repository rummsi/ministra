...
$groups = \Ministra\Lib\S642b6461e59cef199375bfb377c17a39\L18e6d54d6202a6e70c8e428830aa4c89::getInstance()->from('admin_groups')->get()->all();
$id = isset($_GET['id']) ? (int) $_GET['id'] : 0;
if (!empty($_POST['add']) && !empty($_POST['name'])) {
    \Ministra\Lib\Admin::checkAccess(\Ministra\Lib\AdminAccess::ACCESS_CREATE);
    $data = ['name' => $_POST['name']];
    $group_id = \Ministra\Lib\S642b6461e59cef199375bfb377c17a39\L18e6d54d6202a6e70c8e428830aa4c89::getInstance()->insert('admin_groups', $data)->insert_id();
    ...
    if (!empty($access_map)) {
        ...
        if (!empty($access_map)) {
            \Ministra\Lib\S642b6461e59cef199375bfb377c17a39\L18e6d54d6202a6e70c8e428830aa4c89::getInstance()->insert('acl', $access_map);
        }
    }
...
if (!empty($id)) {
    if (!empty($_POST['edit_action']) && !empty($_POST['name'])) {
        ...
        $data = ['name' => $_POST['name']];
        \Ministra\Lib\S642b6461e59cef199375bfb377c17a39\L18e6d54d6202a6e70c8e428830aa4c89::getInstance()->update('admin_groups', $data, ['id' => $id]);
        $access_map = \Ministra\Lib\AdminAccess::convertPostParamsToAccessMap($_POST);
        if (!empty($access_map)) {
            ...
            \Ministra\Lib\S642b6461e59cef199375bfb377c17a39\L18e6d54d6202a6e70c8e428830aa4c89::getInstance()->delete('acl', ['gid' => $id]);
            \Ministra\Lib\S642b6461e59cef199375bfb377c17a39\L18e6d54d6202a6e70c8e428830aa4c89::getInstance()->insert('acl', $access_map);
        }
        \header('Location: admin_groups.php');
        exit;
        ...
        \Ministra\Lib\S642b6461e59cef199375bfb377c17a39\L18e6d54d6202a6e70c8e428830aa4c89::getInstance()->delete('admin_groups', ['id' => $id]);
        \header('Location: admin_groups.php');
        exit;
    }
}
if (isset($_GET['edit']) && !empty($id)) {
    ...
    $action_value = \_('Save');
    $edit_group = \Ministra\Lib\S642b6461e59cef199375bfb377c17a39\L18e6d54d6202a6e70c8e428830aa4c89::getInstance()->from('admin_groups')->where(['id' => $id])->get()->first();
    $access = \Ministra\Lib\S642b6461e59cef199375bfb377c17a39\L18e6d54d6202a6e70c8e428830aa4c89::getInstance()->from('acl')->where(['gid' => $id])->get()->all();
    $edit_group['access'] = [];
