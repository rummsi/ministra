...
?>
    ...
    <head>
        ...
        <title><?php 
echo \_('TV Archive statistics per month');
?></title>
    </head>
<body>
...
$played_archive = \Ministra\Lib\S642b6461e59cef199375bfb377c17a39\L18e6d54d6202a6e70c8e428830aa4c89::getInstance()->select('itv.name, count(ch_id) as counter, ch_id, SUM(length) as total_duration')->from('played_tv_archive')->join('itv', 'itv.id', 'played_tv_archive.ch_id', 'INNER')->where(['playtime>=' => $from_time])->groupby('ch_id')->orderby('counter', 'DESC')->get();
