...
if (@$_GET['del'] && !empty($_GET['id'])) {
    ...
    \Ministra\Lib\S642b6461e59cef199375bfb377c17a39\L18e6d54d6202a6e70c8e428830aa4c89::getInstance()->delete('audio_genres', ['id' => (int) $_GET['id']]);
...
if (!empty($_POST)) {
    if (empty($_POST['name'])) {
        ...
        $genre_id = \Ministra\Lib\S642b6461e59cef199375bfb377c17a39\L18e6d54d6202a6e70c8e428830aa4c89::getInstance()->insert('audio_genres', ['name' => $_POST['name'], 'modified' => 'NOW()'])->insert_id();
        \header('Location: audio_genre.php');
        exit;
    } elseif (isset($_POST['update'])) {
        \Ministra\Lib\Admin::checkAccess(\Ministra\Lib\AdminAccess::ACCESS_EDIT);
        $genre_id = (int) $_GET['id'];
        \Ministra\Lib\S642b6461e59cef199375bfb377c17a39\L18e6d54d6202a6e70c8e428830aa4c89::getInstance()->update('audio_genres', ['name' => $_POST['name'], 'modified' => 'NOW()'], ['id' => $genre_id]);
        \header('Location: audio_genre.php');
        exit;
    }
}
...
$items = \Ministra\Lib\S642b6461e59cef199375bfb377c17a39\L18e6d54d6202a6e70c8e428830aa4c89::getInstance()->from('audio_genres');
...
$items = $items->get();
if (isset($_GET['id'])) {
    $current_genre = \Ministra\Lib\S642b6461e59cef199375bfb377c17a39\L18e6d54d6202a6e70c8e428830aa4c89::getInstance()->from('audio_genres')->where(['id' => (int) $_GET['id']])->get()->first();
}
?>
<body>
...
?>:
                                        ...
                                        <td>
                                            <input name="name" type="text"
                                                   value="<?php 
echo !empty($current_genre) ? $current_genre['name'] : '';
?>">
...
?>"
                                                   onclick="document.location='audio_genre.php'">
                                        </td>
                                    </tr>
                                </table>
                            </form>
