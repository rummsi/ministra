...
$words['month_arr'] = [\_('JANUARY'), \_('FEBRUARY'), \_('MARCH'), \_('APRIL'), \_('MAY'), \_('JUNE'), \_('JULY'), \_('AUGUST'), \_('SEPTEMBER'), \_('OCTOBER'), \_('NOVEMBER'), \_('DECEMBER')];
$words['week_arr'] = [\_('SUNDAY'), \_('MONDAY'), \_('TUESDAY'), \_('WEDNESDAY'), \_('THURSDAY'), \_('FRIDAY'), \_('SATURDAY')];
$words['year'] = '';
...
$words['Channel is locked'] = \_('Channel is locked');
