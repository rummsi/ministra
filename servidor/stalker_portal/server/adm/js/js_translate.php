...
} elseif (!empty($_COOKIE['language']) && (\array_key_exists($_COOKIE['language'], $locales) || \in_array($_COOKIE['language'], $locales))) {
...
$words['action_is_not_available'] = \_('This action is not available');
